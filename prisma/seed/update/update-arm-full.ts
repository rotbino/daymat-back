...
async function main() {
    ...
    const updatedConfig = {
        ...
        formLabels: {
            ...
            'catalog.address.label': 'آدرس',
            'catalog.address.placeholder': 'آدرس کامل را وارد کنید',
            'catalog.city.label': 'شهر',
            'catalog.city.placeholder': 'شهر را انتخاب کنید',
            'catalog.province.label': 'استان',
            'catalog.province.placeholder': 'استان را انتخاب کنید',
            'catalog.position.label': 'سمت شما',
            'catalog.position.placeholder': 'انتخاب سمت...',
            'catalog.industry.label': 'صنف',
            'catalog.industry.placeholder': 'انتخاب صنف...',
        },
