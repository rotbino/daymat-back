...
export class AdService {
    ...
    async derivedNotifications(userId: string) {
        ...
        //    کسب‌وکارِ فعال دارید ولی صفحه درخواست قیمت/کاتالوگ فروش ندارید → یادآوری پایدار تا بسازد
        ...
        try {
            ...
            if (hasBiz > 0 && purchaseCatalogCount === 0) {
                items.unshift({
                    ...
                    severity: 'info',
                    title: 'صفحه درخواست قیمت نداری — شبکهٔ تامینت ناقص است',
                    body: 'تامین‌کننده‌ها از روی صفحه درخواست قیمتت بهت وصل می‌شن و اعلام خریدهای فوریت رو می‌بینن',
                    action: { label: 'ساخت صفحه درخواست قیمت', href: '/inquiries/new' },
                });
            }
            if (hasBiz > 0 && salesCatalogCount === 0) {
                items.unshift({
                    ...
                    body: 'با کاتالوگ فروش، خریدارها از روی صفحه درخواست قیمتشان بهت وصل می‌شن و سرنخ فروش می‌گیری',
