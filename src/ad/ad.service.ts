...
export class AdService {
    ...
    async derivedNotifications(userId: string) {
        ...
        //    کسب‌وکارِ فعال دارید ولی صفحه کاتالوگ خرید/کاتالوگ فروش ندارید → یادآوری پایدار تا بسازد
        ...
        try {
            ...
            if (hasBiz > 0 && purchaseCatalogCount === 0) {
                items.unshift({
                    ...
                    severity: 'info',
                    title: 'صفحه کاتالوگ خرید نداری — شبکهٔ تامینت ناقص است',
                    body: 'تامین‌کننده‌ها از روی صفحه کاتالوگ خریدت بهت وصل می‌شن و اعلام خریدهای فوریت رو می‌بینن',
                    action: { label: 'ساخت صفحه کاتالوگ خرید', href: '/inquiries/new' },
                });
            }
            if (hasBiz > 0 && salesCatalogCount === 0) {
                items.unshift({
                    ...
                    body: 'با کاتالوگ فروش، خریدارها از روی صفحه کاتالوگ خریدشان بهت وصل می‌شن و سرنخ فروش می‌گیری',
