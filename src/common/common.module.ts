...
import { InquiryPublishService } from './services/inquiry-publish.service';
...
@Module({
    ...
    providers: [CatalogPublishService, InquiryPublishService, CatalogAccessService, CacheHelper],
    exports: [CatalogPublishService, InquiryPublishService, CatalogAccessService, CacheHelper],
})
