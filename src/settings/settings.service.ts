...
export class SettingsService {
    ...
    async seedSystemDefaults() {
        const defaults = [
            ...
            { key: 'arms.enforceMatchLimits', value: false, group: 'arms', description: 'اعمال سقف/اعتبار در مچینگ — فعلاً خاموش تا کاربر چیزی از مالی نداند' },
            { key: 'arms.matchFreeRevealsDaily', value: 3, group: 'arms', description: 'تعداد رایگانِ روزانه برداشتن شماره از مچینگ' },
            { key: 'arms.matchMaxRevealsDaily', value: 10, group: 'arms', description: 'حداکثر روزانه برداشتن شماره از مچینگ (با اعتبار)' },
            { key: 'arms.creditPriceToman', value: 1000, group: 'arms', description: 'قیمت هر اعتبار به تومان — سراسری و ثابت' },
            { key: 'arms.freeProductsPerCatalog', value: 20, group: 'arms', description: 'تعداد کالای رایگان هر بازوی فروش' },
            { key: 'arms.packages', value: [], group: 'arms', description: 'بسته‌های پولی بازوها — برای آینده' },
